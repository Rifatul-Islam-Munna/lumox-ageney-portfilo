...
import { BlogCmsForm } from "@/components/admin/blog-cms-form";
      ...
      <SidebarInset>
        <header className="sticky top-0 flex h-14 shrink-0 items-center gap-3 border-b bg-background px-4">
          ...
          <div className="min-w-0">
            <p className="truncate text-sm font-medium">Blog page content</p>
            <p className="truncate text-xs text-muted-foreground">Hero and blog cards.</p>
          </div>
        </header>
        <div className="p-4 md:p-6">
          <BlogCmsForm initialContent={content} />
        </div>
      </SidebarInset>
      <Toaster />
    </SidebarProvider>
