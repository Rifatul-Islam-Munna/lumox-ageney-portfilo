...
import { HomeCmsForm } from "@/components/admin/home-cms-form";
...
const nav = [
  { title: "Home page", href: "/admin/home", icon: HomeIcon, active: true },
...
export default async function AdminHomePage() {
  ...
  try {
    content = (await getHomeContent()) ?? defaultHomeContent;
  } catch {
      ...
      <SidebarInset>
        <header className="sticky top-0 flex h-14 shrink-0 items-center gap-3 border-b bg-background px-4">
          ...
          <div className="min-w-0">
            <p className="truncate text-sm font-medium">Home page content</p>
            <p className="truncate text-xs text-muted-foreground">Hero slider, service bands, works, people, facilities, blog.</p>
          </div>
        </header>
